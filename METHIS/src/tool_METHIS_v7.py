...
parser.add_argument('-s1', '--list_s1', required=True, type=str, help='Parameters for the source population s1: \
							sourcepop1[proportion of s1g0]/model[Con, Inc, Dec, or All]/trend[min-max, or default]/s1g1[min-max, linear, or default]/s1gn[min-max, or default]')
parser.add_argument('-s2', '--list_s2', required=True, type=str, help='Parameters for the source population s2: \
							sourcepop2[proportion of s2g0]/model[Con, Inc, Dec, or All]/trend[min-max, or default]/s2g1[min-max, linear, or default]/s2gn[min-max, or default]')
